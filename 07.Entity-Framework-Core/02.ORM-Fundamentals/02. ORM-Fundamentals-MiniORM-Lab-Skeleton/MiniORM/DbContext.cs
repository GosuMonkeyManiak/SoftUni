...
namespace MiniORM
{
    public abstract class DbContext
    {
            ...
            foreach (IEnumerable<object> dbSet in dbSets)
            {
                ...
                if (invalidEntities.Any())
                {
                    throw new InvalidOperationException(
                        $"{invalidEntities.Count()} Invalid Entities found in {dbSet.GetType().Name}!");
                }
            }
            ...
            foreach (var foreignKey in foreignKeys)
            {
                ...
                foreach (var entity in dbSet)
                {
                    ...
                    var navigationPropertyValue = ((IEnumerable<object>)navigationDbSet)
                        .First(currentNavProp =>
                            navigationPrimaryKey.GetValue(currentNavProp).Equals(foreignKeyValue));
        ...
        private string[] GetEntityColumnNames(Type table)
        {
            ...
            var dbColumn = connection.FetchColumnNames(tableName);
