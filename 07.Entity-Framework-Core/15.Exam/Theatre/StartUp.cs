    ...
    public class StartUp
    {
        ...
        private static void ImportEntities(TheatreContext context, string baseDir, string exportDir)
        {
            var theatersAndTickets =
              DataProcessor.Deserializer.ImportPlays(context, File.ReadAllText(baseDir + "plays.xml"));
            ...
            var plays =
                DataProcessor.Deserializer.ImportTtheatersTickets(context, File.ReadAllText(baseDir + "theatres-and-tickets.json"));
